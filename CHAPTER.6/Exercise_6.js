...
if(fuelLevel1 > 20000 && engineTemperature <= 2500){
  console.log("Full tank. Engines good.");
}else if(fuelLevel1 > 10000 && engineTemperature <= 2500){
  console.log("Fuel level above 50%. Engines good.");
}else if(fuelLevel1 > 5000 && engineTemperature <= 2500){
  console.log("Fuel level above 25%. Engines good.");
}else if(fuelLevel1 <=5000 || engineTemperature > 2500){
  console.log("Check fuel level. Engines running hot.");
}else if(fueLevel1 < 1000 || engineTemperature > 3500 || engineIndicatorLight === "red blinking"){
...
if((fuelLevel1 > 20000) && (engineIndicatorLight !== "red blinking") || (commandOverride)){
